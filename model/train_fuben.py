...
parser.add_argument('--data_dir', type=str, default='dataset/tacred44444')
...
parser.add_argument('--sublayer_first', type=int, default=1, help='Num of the first sublayers in dcgcn block.')
parser.add_argument('--sublayer_second', type=int, default=1, help='Num of the second sublayers in dcgcn block.')
...
parser.add_argument('--kernel_sizes', choices=[3,5,7,9,11],  help='kernel size.')
parser.add_argument('--capsule_input_dim', type=int, default=300, help='capsule dimension.')
parser.add_argument('--cnn_dropout', type=float, default=0.3, help='cnn dropout rate.')
parser.add_argument('--share_weights', type=bool, default=True, help='can use share weights.')
parser.add_argument('--num_iterations', type=int, default=5, help='Dynamic routing iterator num.')
parser.add_argument('--capsule_out_dim', type=int, default=50, help='Capsule out dim')
parser.add_argument('--num_capsule', type=int, default=5, help='relation num')
parser.add_argument('--cnn_output_dim', type=int, default=100, help='cnn out dim')
parser.add_argument('--dep_size', type=int, default=43, help='dependency relation num')
parser.add_argument('--dep_embed_dim', type=int, default=30, help='dependency embedding size')
